...
if __name__ == "__main__":
    ...
    parser.add_argument("Ex0")
    parser.add_argument("Ey0")
    parser.add_argument("Ez0")
    parser.add_argument("tau_E")
    parser.add_argument("Bx0")
    parser.add_argument("By0")
    parser.add_argument("Bz0")
    ...
    with open(args.run_dir + '/options/' + args.result_fname) as f:
        results_list = [probability, E0[0], E0[1], E0[2], tau_E,
                        B0[0], B0[1], B0[2], f_B]
